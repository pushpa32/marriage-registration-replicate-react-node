...
const BrideForm = (props) => {
  ...
  return (
    <div className='mt-5'>
      <form id="form-step1" onSubmit={handleFormSubmit} ref={formRef}>
        ...
        <Box>
          ...
          >
            ...
            {/* header */}
            <Grid12>
              <Box className="form-headings">Bride Details</Box>
            </Grid12>
          ...
          >
            ...
            <Grid12>
              <Box className="form-headings">Bride Present Address</Box>
            </Grid12>
          ...
          >
            ...
            <Grid12>
              <Box className="form-headings">Bride Permanent Address</Box>
            </Grid12>
